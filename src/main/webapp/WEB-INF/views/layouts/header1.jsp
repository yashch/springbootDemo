...
<!-- BEGIN HEADER -->
	<div class="header navbar navbar-default ">
		...
		<!-- END TOP BAR -->
		<div class="container navbar-static-top" ><!-- style="height: 75px" -->
			...
			<div class="navbar-header">
				...
				<a class=" logo-v1" href="javascript:void(0);"> 
					<img src="//${staticResource}/cashier/images/pay_logo-default.png" id="logoimg" alt="">
				</a>
				<!-- END LOGO -->
			</div>
			...
			<div class="navbar-collapse collapse ">
				<ul class="nav navbar-nav">
					<li class="dropdown " id="home" ><!--  -->
						<a  class="dropdown-toggle" data-delay="0" data-close-others="false">&nbsp;</a>
					</li>
					<li class="dropdown ">
						<a  class="dropdown-toggle" data-delay="0" data-close-others="false">&nbsp;</a>
					</li>
