<%@ page language="java" pageEncoding="UTF-8" %>
	...
	<script src="static/js/payapp.js"></script>
	<script src="static/js/jquery.cookie.js"></script>
	<script src="static/js/index.js"></script>
	<!-- <script type="text/javascript" src="static/js/??back-to-top.js,jquery.fancybox.pack.js,jquery.themepunch.plugins.min.js,jquery.themepunch.revolution.min.js,jquery.bxslider.min.js,payapp.js,jquery.cookie.js,index.js"></script> -->
