var App = function () {
    ...
    var handleFixedHeader = function() {
        ...
        if ( sy >= changeHeaderOn ) {
                ...
                $('#logoimg').attr('width', '39px');
                $('#logoimg').attr('height', '38px');
                $('#logoimg').attr('src', imgPath+'images/neea.png');
                ...
                $('#logoimg').attr('width', '214px');
                $('#logoimg').attr('height', '50px');
//                $('#logoimg').attr('src', imgPath+'img/neea_font.png');
                $('#logoimg').attr('src', imgPath+'images/pay_logo-default.png');
                $('#logoimg').css('margin-top', '12px');
                $('#login-info').show();
            }
            didScroll = false;
        }
